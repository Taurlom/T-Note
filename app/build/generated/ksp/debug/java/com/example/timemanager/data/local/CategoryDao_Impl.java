...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`color`,`position`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfCategoryEntity = new EntityDeletionOrUpdateAdapter<CategoryEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`name` = ?,`color` = ?,`position` = ? WHERE `id` = ?";
      }
  ...
  public Flow<List<CategoryEntity>> getAll() {
    final String _sql = "SELECT * FROM categories ORDER BY position ASC, name ASC";
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CategoryEntity(_tmpId,_tmpName,_tmpColor,_tmpPosition);
            _result.add(_item);
          }
          return _result;
        } finally {
