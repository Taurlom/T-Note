...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTaskEntity = new EntityInsertionAdapter<TaskEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`title`,`description`,`isCompleted`,`categoryId`,`createdAt`,`position`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTaskEntity = new EntityDeletionOrUpdateAdapter<TaskEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`description` = ?,`isCompleted` = ?,`categoryId` = ?,`createdAt` = ?,`position` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Flow<List<TaskEntity>> getByCategory(final long categoryId) {
    final String _sql = "SELECT * FROM tasks WHERE categoryId = ? ORDER BY isCompleted ASC, position ASC, createdAt DESC";
      ...
      public List<TaskEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TaskEntity(_tmpId,_tmpTitle,_tmpDescription,_tmpIsCompleted,_tmpCategoryId,_tmpCreatedAt,_tmpPosition);
            _result.add(_item);
          }
          return _result;
        } finally {
